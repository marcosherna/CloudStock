...
const createSchema = omitFields(brandSchema, ["id"]);
const updateSchema = makeOptional(brandSchema, ["name"]);
...
module.exports = {
  Id: () =>
    param("id")
      ...
      .toInt(),
  CreateBrand: () => checkSchema(createSchema),
  UpdateBrand: () => checkSchema(updateSchema),
  brandSchema,
  createSchema,
  updateSchema,
};
